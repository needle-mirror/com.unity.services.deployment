...
namespace Unity.Services.Deployment.Editor.DeploymentDefinitions
{
    ...
    {
        public static DeploymentDefinition DefinitionForPath(this IDeploymentDefinitionService service, string path)
        {
            if (path == null)
            {
                return null;
            ...
            DeploymentDefinition bestDefinition = null;
        ...
        public static bool HasDuplicateDeploymentDefinitions(this IDeploymentDefinitionService service, out string duplicationError)
        {
            ...
            if (duplicates.Any())
            {
                ...
                Logger.LogError(duplicationError);
